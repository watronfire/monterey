...
if __name__ == "__main__":
    t = load_tree( tree_loc="results/trees/SanDiego-BajaCalifornia/SanDiego-BajaCalifornia.actual.1.tree" )
    tl = [i.label for i in t.taxon_namespace]

    md = load_metadata( md_loc="resources/combined_md.csv", tip_labels=tl )
    breakpoint()
